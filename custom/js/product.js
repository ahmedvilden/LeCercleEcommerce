		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(discount == "") {
						$("#discount").after('<p class="text-danger">Product Name field is required</p>');
						$('#discount').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#discount").find('.text-danger').remove();
						// success out for form 
						$("#discount").closest('.form-group').addClass('has-success');	  	
					}	// /else
					if(description == "") {
						$("#description").after('<p class="text-danger">Product Name field is required</p>');
					...
					if(sizeName == ""){
						$("#editSize").after('<p class="text-danger">Category Name field is required</p>');
						$('#editSize').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editSize").find('.text-danger').remove();
						// success out for form 
						$("#editSize").closest('.form-group').addClass('has-success');	  	
					}
					if(productStatus == "") {
					...
					if(productName && quantity && rate && brandName && genderName && editSize && categoryName && productStatus && description && discount) {
