...
<?php require_once 'php_action/fetchCheckout.php' ; ?>
...
<div class="row">
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    ...
	    <li><form name="monform2" id="monform" method="GET" action="php_action/approveProduct"><a href="php_action/approveCheckout.php?checkoutid='.$output['data'][$key][0].'" onclick="sure2();" name="checkoutid" value="'.$output['data'][$key][0].'" id="'.$output['data'][$key][0].'" <i class="glyphicon glyphicon-edit"></i> Approve Checkout</a></form></li>
	   
	    <li><form name="monform" id="monform" method="GET" action="php_action/removeCheckout"><a href="php_action/removeProduct.php?checkoutid='.$output['data'][$key][0].'"value="'.$output['data'][$key][0].'" id="'.$output['data'][$key][0].'" onclick="sure();" name"btnSubmit"> <i class="glyphicon glyphicon-trash"></i> Remove</a></form></li>       
	  </ul>
	</div>'.'</td>
                               </tr>  
                               ';  
