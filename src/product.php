...
<?php require_once 'php_action/fetchProduct.php' ; ?>
...
<div class="row">
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    ...
	    <li><a type="button" data-toggle="modal" data-target="#editProductModal" onclick="editProduct('.$output['data'][$key][9].')"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
	   
	    <li><form name="monform" id="monform"><button onclick="sure();" name"btnsubmit" type="submit"><input type="hidden" value=value="'.$output['data'][$key][9].'" id="idsupp"> <i class="glyphicon glyphicon-trash"></i> Remove</button></form></li>       
	  </ul>
	</div>'.'</td>
                               </tr>  
                               ';  
    	...
    	<form id="formadd" name="formadd" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="Product Name" name="productName" autocomplete="off" id="name">
				    </div>
	        </div> <!-- /form-group-->	    
	      ...
	      <div class="modal-footer">
	        ...
	        <button onclick="javascript:alert(1);try{valider()}catch(e){alert(e)}" type="submit" class="btn btn-primary"  data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
	      </div> <!-- /modal-footer -->	      
     	</form> <!-- /.form -->	     
    </div> <!-- /modal-content -->    
  </div> <!-- /modal-dailog -->
    ...
    <div class="modal-content">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="discount" placeholder="discount" name="discount" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->      	 
	        	...
	        	<label class="col-sm-1 control-label">: </label>
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editGender" name="editGender" >
						      	<option value="">~~SELECT~~</option>
						      	<?php 
						      	$sql = "SELECT id, gender FROM gender";
										$result = $connect->query($sql);
			         ...
			         <div class="form-group">
			        	<label for="editSize" class="col-sm-3 control-label">Size : </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editSize" name="editSize" >
						      	<option value="">Product size :</option>
						      	<?php 
						      	$sql = "SELECT id, size FROM size";
										$result = $connect->query($sql);
...
<script src="custom/js/testadd.js"></script>
<script>
...
$('button.zoomMinus').click(function(){
  $('.zoomin img').removeClass('zoomer');
	...
	function sure() {
     ...
     var x;
     var id = document.getElementById("idsupp").value;
     var string1="php_action/removeProduct.php?productId="
     string1 = string1.concat(id);
     if (confirm("Are you sure?") == true) {
        document.monform.method="GET";
		document.monform.action=string1
