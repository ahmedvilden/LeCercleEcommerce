...
<?php require_once 'php_action/fetchCategories.php' ; ?>
<div class="row">
	<div class="col-md-12">
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    ...
	    <li><a type="button" data-toggle="modal" data-target="#editBrandModel" onclick="editCategories('.$output['data'][$key][3].')"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
	   
	    <li><form name="monform" id="monform" method="GET" action="php_action/removeCategories"><a href="php_action/removeCategories.php?categorieId='.$output['data'][$key][3].'"value="'.$output['data'][$key][3].'" id="'.$output['data'][$key][3].'" onclick="sure();" name"btnSubmit"> <i class="glyphicon glyphicon-trash"></i> Remove</a></form></li>       
	  </ul>
	</div>'.'</td>
                               </tr>  
                               ';  
