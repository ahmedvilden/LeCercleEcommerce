...
<head>
    ...
    <title>Shop || Boyka - Fashion eCommerce Bootstrap 4 HTML5 Template</title>
            ...
            <div class="row">
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <div class="sidebar-categores-box">
                        <form action="shopfiltered.php" method="GET">
                        ...
                        <label><input type="checkbox" name="cat" value="<?php echo $output1['data'][$key][0]; ?>"  > <?php  echo $output1['data'][$key][1]; ?></label>
                    </div>     
                    <?php } ?>    
                    <div class="sidebar-title">
                            <h2>Genders</h2>
                          ...
                          { ?> 
                            <div class="list-group-item checkbox">
                        <label><input type="checkbox" name="gender" value="<?php echo $output2['data'][$key][0]; ?>"  > <?php  echo $output2['data'][$key][1]; ?></label>
                    </div>
                    ...
                    <div class="sidebar-categores-box">
                        ...
                        <!-- btn-clear-all start -->
                        <button class="btn-clear-all" type="submit">Filter</button>
                        <!-- btn-clear-all end -->
                        ...
                        <div class="filter-sub-area">
                            ...
                            <div class="price-checkbox">
                                    <ul>
                                        <li><input type="radio" name="price" value="price between 10 and 15">10.00DT - 15.00DT</a></li>
                                        <li><input type="radio" name="price" value="price between 16 and 25">>16.00DT - 25.00DT </a></li>
                                        <li><input type="radio" name="price" value="price between 26 and 35">>26.00DT - 35.00DT</a></li>
                                        <li><input type="radio" name="price" value="price between 36 and 45">>36.00DT - 45.00DT (1)</a></li>
                                        <li><input type="radio" name="price" value="price between 46 and 55">>46.00DT - 55.00DT (5)</a></li>
                                        <li><input type="radio" name="price" value="price between 56 and 100">> 56.00DT - 100.00DT (1)</a></li>
                                        <li><input type="radio" name="price" value="price > 100">> >>>100DT (2) </a></li>
                                    </ul>
                            </div>
                        </div>
                        <!-- filter-sub-area end -->
                            ...
                            <div class="size-checkbox">
                                    <ul>
                                        ...
                                        foreach ($output3['data'] as $key => $value)
                                            { ?> 
                                        <li><input type="checkbox" name="size" value="<?php echo $output3['data'][$key][0]; ?>" ><a href="#"><?php echo $output3['data'][$key][1]; ?></a>
                                            <?php } ?>
                                        </li>                    
                                    </ul>
                            </div>
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    ...
                    <div class="shop-products-wrapper">
                        <form action="productdetails.php" method="GET" id="contactForm">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mt-30">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <input type="hidden" name="idproduct" value="<?php echo $output['data'][$key][8]; ?>">
                                                    <a href="productdetails.php?idproduct=<?php echo $output['data'][$key][8]; ?>"><?php echo $output['data'][$key][1]; ?></a>
                                                ...
                                                <div class="product-content">
                                                    <h3><a><?php echo $output['data'][$key][0]; ?></a></h3>
                                                    <div class="price-box">
                                                        <?php 
