...
if(isset($_SESSION['userId'])) {
    header('location: http://localhost/stock/boyka-v2/boyka/index.php');   
}
if($_POST) {        
...
<!-- Mirrored from demo.devitems.com/boyka-v2/boyka/login-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 May 2019 16:02:35 GMT -->
<head>
	<style type="text/css">
		.vendor_logo_hide{
                                    ...
                                    <div class="login-register-form">
                                        <form action="register.php" method="post" enctype="multipart/form-data">
                                            <div class="login-input-box">
                                                ...
                                                <select name="gender" style="width: 100%;height: 50%;">
                                                ...
                                                <input name="birthday" placeholder="Birth date" type="date">
                                                <input type="file" class="form-control" id="profilepic" placeholder="Profile picture" name="profilepic" class="file-loading" style="width:auto;"/>
                                            </div>
                                            <div class="button-box">
