                                         ...
                                         <div class="login">
                                            <div class="login-form-container">
                                                <div class="account-login-form">
                                                    <form enctype="multipart/form-data" action="../../php_action/newproduct.php" method="POST">
                                                        ...
                                                        <div class="account-input-box">  
                                                            ...
                                                            <textarea id="description" name="description" style="width: 100%;" placeholder="Product description"></textarea> 
                                                            <label>Brand :</label>
                                                      ...
                                                      <select type="text" class="form-control" id="sizeName" name="sizeName" >
                                                        ...
                                                        <input type="file" class="form-control" id="picture" placeholder="Product Name" name="picture" class="file-loading" style="width:auto;"/>
                                                        </div>                                                        
